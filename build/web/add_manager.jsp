      ...
      <ul class="sidenav" id="mobile-demo">
        ...
        <div class="row">
            ...
            <div class="col l6 m6 s12">
                <form action="add_manager.jsp" method="post">
                    <label><h5> Name</h5></label>
                    <input type="text" name="mng_name" required>
                    <label><h5> Password</h5></label>
                    <input type="text" name="mng_pass" required>
                    <label><h5>E-Mail </h5></label>
                    <input type="text" name="mng_mail" required>
                    <label><h5>Contact No.</h5></label>
                    <input type="text" name="mng_contact" required>
