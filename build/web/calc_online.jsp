...
<%
    String sell_amt=session.getAttribute("mamt").toString();
    ...
    String qry="select * from stock where name='"+session.getAttribute("mname")+"'and category='"+session.getAttribute("mcategory")+"'";
    ...
    if(rs.next())
    {
        ...
        String sql="update stock set available=? where name='"+session.getAttribute("mname")+"'and category='"+session.getAttribute("mcategory")+"'";
