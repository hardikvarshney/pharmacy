...
public final class add_005fcashier_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(request.getParameter("add_mgr")!=null)
    {
      ...
      out.write("            window.open(\"admin_dash.jsp\",\"_self\");   \n");
      out.write("        </script>\n");
      out.write("        ");
      ...
      out.write("                <form action=\"add_cashier.jsp\" method=\"post\">\n");
      out.write("                    <label><h5> Name</h5></label>\n");
      out.write("                    <input type=\"text\" name=\"cas_name\" required>\n");
      out.write("                    <label><h5> Password</h5></label>\n");
      out.write("                    <input type=\"text\" name=\"cas_pass\" required>\n");
      out.write("                    <label><h5>E-Mail </h5></label>\n");
      out.write("                    <input type=\"text\" name=\"cas_mail\" required>\n");
      out.write("                    <label><h5>Contact No.</h5></label>\n");
      out.write("                    <input type=\"text\" name=\"cas_contact\" required>\n");
